...
#if defined AK_ANDROID || defined AK_LINUX || defined AK_MAC_OS_X || defined AK_EMSCRIPTEN
#include <dlfcn.h>
#elif defined AK_NX
#include <nn/mem.h>
#endif
...
#if defined(__ANDROID__) || defined(AK_LINUX) || defined(AK_NX) || defined(AK_EMSCRIPTEN)
...
AKRESULT Init(AkInitializationSettings* settings)
{
	...
	{
		memSettings.bEnableSeparateDeviceHeap = true;
	}
#endif // AK_XBOX
